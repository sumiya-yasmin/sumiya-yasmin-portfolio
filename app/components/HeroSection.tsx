...
export const HeroSection = () => {
  ...
  return (
    <motion.div className="flex flex-col lg:flex-row justify-between items-center max-w-6xl mx-auto px-6"
    ...
    >
      <div className="flex-1 max-w-xl mb-10 lg:mb-0">
        <div className="flex flex-col gap-5">
          ...
          <span className="text-[var(--color-accent-secondary)]"> Software Engineer</span></motion.p>
      ...
      <motion.div className="flex-1 w-full aspect-[3/4] lg:aspect-[1/1] relative max-w-md lg:h-[650px]"
