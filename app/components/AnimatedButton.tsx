...
export const AnimatedButton: React.FC<AnimatedButtonProps> = ({
  ...
  const baseClasses =
    "px-8 py-3 rounded-md cursor-pointer text-sm font-semibold overflow-hidden relative custom-btn-animation " + "transition-shadow duration-300 shadow-xl hover:shadow-2xl transform";
